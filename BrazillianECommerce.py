...
page = st.sidebar.radio(
    "Navigation", 
    ("Main Dashboard", "Top 5 Purchased Products", "Top 5 Produced Products", "Total Spending State")
)
...
# Page 2: Top 5 Purchased Products
    ...
    if selected_state == 'AC':
        ...
        st.write("""Weather plays a significant role, with dry conditions encouraging outdoor activities and wet weather driving indoor pursuits. Seasonal lifestyle changes, cultural factors, and regional preferences could also influence product demand.""")
...
# Page 3: Top 5 Produced Products
    ...
    st.write(
        "To analyze the data seasonally, the code defines a function that categorizes orders into either ""wet"" or ""dry"" seasons based on the month of the order date. It adds this seasonal information to the DataFrame and calculates the count of products sold by seller state and season. Finally, the code identifies the top five most produced products for each seller state during both wet and dry seasons, resulting in a refined DataFrame that highlights the most popular products based on seasonal sales across different states."
    ...
    explanations = {
        ...
        'SP': "São Paulo adalah negara bagian yang paling padat penduduknya dan merupakan pusat ekonomi Brasil. Dikenal dengan industri dan perdagangan yang kuat, São Paulo memiliki beragam produk, termasuk kopi, gula, dan hasil pertanian. Selain itu, kota São Paulo adalah pusat budaya yang dinamis dengan berbagai festival, museum, dan seni pertunjukan. Masyarakat di São Paulo memiliki tradisi kuliner yang kaya dan beragam, mencerminkan keanekaragaman etnis dan budaya yang ada.",
